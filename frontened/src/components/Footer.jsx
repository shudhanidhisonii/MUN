...
const Footer = () => {
  return (
    <>
      <footer className="footer footer-horizontal footer-center bg-[#062045] text-white rounded p-10">
        ...
        <aside>
          <p>Copyright © {new Date().getFullYear()} - All rights reserved by KIET MUN Society</p>
        </aside>
      </footer>
    </>
  )
